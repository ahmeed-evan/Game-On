...
public class PlayerPointDetailsAdapterFootball extends RecyclerView.Adapter<PlayerPointDetailsAdapterFootball.PointDetailsViewHolder> {

    private Context context;
    private List<PlayerPoint> playerPointDetailsList;

    public PlayerPointDetailsAdapterFootball(Context context, List<PlayerPoint> playerPointDetailsList) {
